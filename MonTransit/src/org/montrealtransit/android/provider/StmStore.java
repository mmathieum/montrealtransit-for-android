...
public class StmStore {
	...
	public static class BusStop implements BaseColumns, SubwayStationsColumns, BusLinesColumns, BusStopLocationColumns, BusStopsColumns {
		...
		/**
		 * The order by bus line number and bus stop order.
		 */
		public static final String ORDER_BY_LINE_STOP_ORDER = StmDbHelper.T_BUS_STOPS_K_LINE_NUMBER + ", " + StmDbHelper.T_BUS_STOPS_K_STOPS_ORDER + " ASC";
		/**
